 ...
 *
 * 1) Invert order of base and inductive cases
 * 2) Change if() into while() on inductive case and
 *    move base case out of loop
 * 3) replace recursive calls to select0() by resetting
 *    value of hi if k<p or lo if k > p
 */
